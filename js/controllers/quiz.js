...
(function(){
    ...
    function QuizController(quizMetrics, DataService){
		...
		function plotGraph(){
			if(quizMetrics.numCorrect>0){
				var correct_answers = quizMetrics.numCorrect;
				var total_questions = DataService.quizQuestions.length;
				console.log(correct_answers);
				console.log(total_questions);
                
                var xx = JSON.stringify(correct_answers);
                console.log(xx);
			}			
		}
